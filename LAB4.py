...
user_number = input("Please enter number between 3-7 including: ")
password = ""
while True:
    if int(user_number) < 3 or int(user_number) > 7:
        ...
        for y in range(int(user_number)):
...
for x in range(5):
    if int(user_number) <5 :
        my_set1.add(random.choice(words))


    else:
        my_set2.add(random.choice(words))
...
merged_dictionary2=sorted(merged_dictionary)
print(merged_dictionary2)


items_value=sorted(merged_dictionary)
print(items_value)
